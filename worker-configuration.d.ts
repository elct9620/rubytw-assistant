/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f91e50eea00fdee990cbe9ea64707a88)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUMMARY_HOURS" | "SUMMARY_ITEM_LIMIT" | "AI_MODEL" | "CF_ACCOUNT_ID" | "AI_GATEWAY_ID" | "MEMORY_ENTRY_LIMIT" | "ENVIRONMENT" | "LANGFUSE_BASE_URL" | "DEBUG" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "DISCORD_CHANNEL_ID" | "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY" | "GITHUB_INSTALLATION_ID" | "GITHUB_ORG" | "GITHUB_PROJECT_NUMBER" | "CF_AIG_TOKEN">> {}
}
declare module "*.md" {
	const value: string;
