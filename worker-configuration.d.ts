/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 45fedfbf16fe3bb1aa8798f40f7d94ac)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUMMARY_HOURS" | "SUMMARY_ITEM_LIMIT" | "AI_MODEL" | "CF_ACCOUNT_ID" | "AI_GATEWAY_ID" | "MEMORY_ENTRY_LIMIT" | "DEBUG" | "DISCORD_PUBLIC_KEY" | "DISCORD_BOT_TOKEN" | "DISCORD_CHANNEL_ID" | "GITHUB_APP_ID" | "GITHUB_PRIVATE_KEY" | "GITHUB_INSTALLATION_ID" | "CF_AIG_TOKEN">> {}
}
declare module "*.md" {
	const value: string;
